              ...
              >
                ...
                {activeSlides === 2 && index === 0 && (
                  <>
                    ...
                    {slides[index + 1] && (
                      <Grid item container xs={12} lg={6} sx={styles.lgDisplay}>
                ...
                {activeSlides === 3 && index === 0 && (
                  <>
                    ...
                    {slides[index + 1] && (
                      <Grid item container xs={12} lg={4} sx={styles.lgDisplay}>
                        {slides[index + 1]?.slideContent}
                      </Grid>
                    )}
                    {slides[index + 2] && (
                ...
                {activeSlides === 4 && index === 0 && (
                  <>
                    <Grid item container xs={12} lg={3}>
                      {slide?.slideContent}
                    </Grid>
                    {slides[index + 1] && (
                      <Grid item container xs={12} lg={3} sx={styles.lgDisplay}>
                        {slides[index + 1]?.slideContent}
                      </Grid>
                    )}
                    {slides[index + 2] && (
                ...
                {activeSlides === 4 && index !== 0 && (
                  <>
                    {slides[index * activeSlides]?.slideContent && (
                      <Grid item xs={3} lg={3} sx={styles.lgDisplay}>
                        {slides[index * activeSlides]?.slideContent}
                      </Grid>
                    )}
                    {slides[index * activeSlides + 1]?.slideContent && (
                    ...
                    {slides[index * activeSlides + 3]?.slideContent && (
                      <Grid item xs={3} lg={3} sx={styles.lgDisplay}>
                        {index === 0
                          ? slides[index + 3]?.slideContent
                          : slides[index * activeSlides + 3]?.slideContent}
